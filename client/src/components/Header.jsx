      ...
      {item.type === "link" ? (
        <>
          ...
          {item.name}
            ...
            <span className='cursor-pointer text-blue-500 absolute transition-all duration-500 font-bold right-0 top-0 opacity-0 group-hover:right-[90%] opacity-0 group-hover:opacity-100'>
            +
            </span>
        </>
      ) : (
